...
function HomeCarousel() {
  return (
    ...
    >
      {Array.from({ length: 7 }).map((_, index) => (
        <SwiperSlide className="relative !w-full" key={index}>
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-b from-transparent to-black min-h-[351px] flex items-end justify-center">
            <div
              className={`${roboto.className} flex flex-col gap-4 items-center text-center justify-end pb-9 text-white max-w-[485px]`}
            >
              <h1 className="text-[55px] font-light leading-[60px]">Upsale</h1>
      ...
      <div className="swiper-pagination !absolute !w-fit px-4 min-h-[20px] bg-black rounded-full !bottom-9 !left-16 flex items-center gap-3"></div>
      <div className="absolute right-16 bottom-9 flex justify-between min-h-[40px] min-w-[92px]">
